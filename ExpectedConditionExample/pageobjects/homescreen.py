...
from expectedconditions.check_title_and_logo import CheckTitleAndLogo
...
class HomeScreen:
    ...
    def validate_title_and_logo(self):
        assert WebDriverWait(self.driver.instance, 10).until(CheckTitleAndLogo((By.CLASS_NAME, "site-title"),
